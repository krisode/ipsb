...
{
    public class VisitPointHandler : AuthorizationHandler<OperationAuthorizationRequirement, VisitPoint>
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, VisitPoint resource)
        {
