...
namespace IPSB.Controllers
{
    ...
    public class VisitPointController : AuthorizeController
    {
        ...
        public async Task<ActionResult<VisitPointCM>> CreateBuilding([FromQuery] VisitPointCM model)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult> PutVisitPoint(int id, [FromForm] VisitPointUM model)
        {
